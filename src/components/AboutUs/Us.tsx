            ...
            <Box bgColor="gray.100" p={4}>
                <Flex direction={{ base: 'column', md: 'row' }}>
                    ...
                    <Box ml={4} mt={{ base: 4, md: 0 }} pt={{ base: 0, md: "15%" }}>
                        <Text fontSize="2xl" fontWeight="bold" color={{base:Light.colorTitle,_dark:Dark.colorTitle}} fontFamily="Relaway">NOSOTROS</Text>
                        <Text
                            fontWeight="bold"
                            fontFamily={Light.fontFamilyContent}
                            fontSize="lg"
                            color="black"
                            lineHeight="tall"
                            letterSpacing="tight"
