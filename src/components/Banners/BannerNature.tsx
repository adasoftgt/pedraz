        ...
        <Box maxW="1200px" mx="auto" p={8} rounded="md" shadow="md" zIndex={2} position="relative">
            ...
            <Stack direction={{base:"column",md:"row"}} position="relative">
                <Box mx="auto"  rounded="md" position="relative">
                    ...
                    <Text fontSize="xl" textAlign="justify" color={{ base: Light.colorDescriptionDarkBackgroundImage, _dark: Dark.colorDescriptionDarkBackgroundImage }} mt={{base:8,md:175}} >
                        {description}
                    </Text>
                    <Text fontSize="xl" textAlign="justify" color={{ base: Light.colorDescriptionDarkBackgroundImage, _dark: Dark.colorDescriptionDarkBackgroundImage }} mt={{base:8,md:8}} >
                        {description2}
                    </Text>
